...
import { PlusCircle, MinusCircle, DollarSign, TrendingUp, TrendingDown, Calendar, Trash2, Edit2, Save, X } from 'lucide-react';
  ...
  const getMotivationalQuote = () => {
    if (balance > 0) {
      const positiveQuotes = [
        "¡Excelente Fiorella! 💪 Estás ahorrando y construyendo tu futuro financiero.",
      ...
      const improvementQuotes = [
        "Fio, es momento de revisar tus gastos 💡 Pequeños cambios hacen grandes diferencias.",
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 bg-gradient-to-br from-blue-50 to-indigo-100 min-h-screen">
      <div className="bg-white rounded-xl shadow-lg p-6 mb-6">
        ...
        <p className="text-gray-600 mb-6">Gestiona tus ingresos y gastos personales de forma inteligente</p>
